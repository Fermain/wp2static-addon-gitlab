...
define( 'WP2STATIC_GITLAB_PRIVATE_VERSION', '1.5.2' );
...
register_activation_hook( __FILE__, function() {
    ...
    add_option( 'wp2static_gitlab_private_deploy_strategy', 'direct' );
    add_option( 'wp2static_gitlab_private_target_branch', 'main' );
} );
